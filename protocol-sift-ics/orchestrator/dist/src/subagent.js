...
export class AnthropicSubagentRunner {
    client;
    constructor(apiKey) {
...
export const SUBMIT_TOOL_REQUEST = {
    name: "submit_tool_request",
    description: "Submit a typed forensic-tool request to the Tool Broker. Branch agents " +
...
export function toolsForSkill(skill, mcpTools) {
