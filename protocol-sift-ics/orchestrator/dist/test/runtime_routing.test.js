...
import { SafetyMirror } from "../src/safety/safety_mirror.js";
...
test("RR-003: non-situation-unit COP write rejected", async () => {
    ...
    for (const id of candidates) {
        await assert.rejects(() => cop.write(id, {
            caseId: "test",
            period: 1,
            updatedAt: "",
            objectives: [],
            ...
            contradictions: [],
            narrative: "",
        }), /attempted COP write/, `${id} should not be allowed to write COP`);
    }
...
//# sourceMappingURL=runtime_routing.test.js.map